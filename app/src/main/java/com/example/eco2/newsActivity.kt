...
class newsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        refreshBtn.setOnClickListener {
            Thread(Runnable {
                ...
                val elements =
                    doc.getElementsByAttributeValue("class", "list_body newsflash_body")

                var element: org.jsoup.nodes.Element= elements.get(0)
                var photoElement: Elements = element.getElementsByAttributeValue("class","photo")
                ...
                photoElement.forEach { item ->
                        ...
                        var mNews = Item(item_title, item_link, item_thumb)
    ...
    data class Item(val title: String, val link: String, val thumb: String)
